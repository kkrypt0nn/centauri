...
func (c *Client) GetChannelWebhooks(channelID string) ([]discord.Webhook, error) {
	return DoRequestAsList[discord.Webhook](c, "GET", ChannelsEndpoint+"/"+channelID+"/webhooks", nil, 1)
}
...
func (c *Client) GetGuildWebhooks(guildID string) ([]discord.Webhook, error) {
	return DoRequestAsList[discord.Webhook](c, "GET", GuildsEndpoint+"/"+guildID+"/webhooks", nil, 1)
}
...
func (c *Client) GetWebhook(webhookID string) (*discord.Webhook, error) {
	return DoRequestAs[discord.Webhook](c, "GET", WebhooksEndpoint+"/"+webhookID, nil, 1)
}
...
func (c *Client) GetWebhookWithToken(webhookID, webhookToken string) (*discord.Webhook, error) {
	return DoRequestAs[discord.Webhook](c, "GET", WebhooksEndpoint+"/"+webhookID+"/"+webhookToken, nil, 1)
}
...
func (c *Client) GetWebhookMessage(webhookID, webhookToken, messageID, threadID string) (*discord.Message, error) {
	...
	return DoRequestAs[discord.Message](c, "GET", WebhooksEndpoint+"/"+webhookID+"/"+webhookToken+"/messages/"+messageID, queryParams, 1)
}
