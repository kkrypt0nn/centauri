...
func (c *Client) CreateWebhook(channelID discord.Snowflake, webhook discord.CreateWebhook) (*discord.Webhook, error) {
	return DoRequestAsStructure[discord.Webhook](c, "POST", ChannelsEndpoint+"/"+channelID.String()+"/webhooks", webhook, nil, 1, WithReason(webhook.AuditLogReason))
}
...
func (c *Client) GetChannelWebhooks(channelID discord.Snowflake) ([]discord.Webhook, error) {
	return DoRequestAsList[discord.Webhook](c, "GET", ChannelsEndpoint+"/"+channelID.String()+"/webhooks", nil, nil, 1)
}
...
func (c *Client) GetGuildWebhooks(guildID discord.Snowflake) ([]discord.Webhook, error) {
	return DoRequestAsList[discord.Webhook](c, "GET", GuildsEndpoint+"/"+guildID.String()+"/webhooks", nil, nil, 1)
}
...
func (c *Client) GetWebhook(webhookID discord.Snowflake) (*discord.Webhook, error) {
	return DoRequestAsStructure[discord.Webhook](c, "GET", WebhooksEndpoint+"/"+webhookID.String(), nil, nil, 1)
}
...
func (c *Client) GetWebhookWithToken(webhookID discord.Snowflake, webhookToken string) (*discord.Webhook, error) {
	return DoRequestAsStructure[discord.Webhook](c, "GET", WebhooksEndpoint+"/"+webhookID.String()+"/"+webhookToken, nil, nil, 1)
}
...
func (c *Client) ModifyWebhook(webhookID discord.Snowflake, webhook discord.ModifyWebhook) (*discord.Webhook, error) {
	return DoRequestAsStructure[discord.Webhook](c, "PATCH", WebhooksEndpoint+"/"+webhookID.String(), webhook, nil, 1, WithReason(webhook.AuditLogReason))
}
...
func (c *Client) ModifyWebhookWithToken(webhookID discord.Snowflake, webhookToken string, webhook discord.ModifyWebhookWithToken) (*discord.Webhook, error) {
	return DoRequestAsStructure[discord.Webhook](c, "PATCH", ChannelsEndpoint+webhookID.String()+"/"+webhookToken, webhook, nil, 1, WithReason(webhook.AuditLogReason))
}
...
func (c *Client) DeleteWebhook(webhookID discord.Snowflake) error {
	return DoEmptyRequest(c, "DELETE", WebhooksEndpoint+"/"+webhookID.String(), nil, nil, 1)
}
...
func (c *Client) DeleteWebhookWithToken(webhookID discord.Snowflake, webhookToken string) error {
	return DoEmptyRequest(c, "DELETE", WebhooksEndpoint+"/"+webhookID.String()+"/"+webhookToken, nil, nil, 1)
}
...
func (c *Client) ExecuteWebhook(webhookID discord.Snowflake, webhookToken string, threadID discord.Snowflake, message discord.ExecuteWebhook) error {
	...
	if len(message.Files) >= 1 {
		...
		return DoEmptyRequestWithFiles(c, "POST", WebhooksEndpoint+"/"+webhookID.String()+"/"+webhookToken, body, queryParams, 1, WithHeader("Content-Type", contentType))
	} else {
		return DoEmptyRequest(c, "POST", WebhooksEndpoint+"/"+webhookID.String()+"/"+webhookToken, message, queryParams, 1)
	}
}
...
func (c *Client) GetWebhookMessage(webhookID discord.Snowflake, webhookToken string, messageID, threadID discord.Snowflake) (*discord.Message, error) {
	...
	return DoRequestAsStructure[discord.Message](c, "GET", WebhooksEndpoint+"/"+webhookID.String()+"/"+webhookToken+"/messages/"+messageID.String(), nil, queryParams, 1)
}
...
func (c *Client) EditWebhookMessage(webhookID, messageID discord.Snowflake, webhookToken string, threadID discord.Snowflake, message discord.EditWebhookMessage) (*discord.Webhook, error) {
	...
	if len(message.Files) >= 1 {
		...
		return DoRequestAsStructure[discord.Webhook](c, "PATCH", WebhooksEndpoint+"/"+webhookID.String()+"/"+webhookToken+"/messages/"+messageID.String(), body, queryParams, 1, WithHeader("Content-Type", contentType))
	} else {
		return DoRequestAsStructure[discord.Webhook](c, "PATCH", WebhooksEndpoint+"/"+webhookID.String()+"/"+webhookToken+"/messages/"+messageID.String(), message, queryParams, 1)
	}
}
...
func (c *Client) DeleteWebhookMessage(webhookID, messageID discord.Snowflake, webhookToken string, threadID discord.Snowflake) error {
	...
	return DoEmptyRequest(c, "DELETE", WebhooksEndpoint+"/"+webhookID.String()+"/"+webhookToken+"/messages/"+messageID.String(), nil, queryParams, 1)
}
