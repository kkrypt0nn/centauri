...
func (c *Client) GetGuildTemplate(templateCode string) (*discord.GuildTemplate, error) {
	return DoRequestAs[discord.GuildTemplate](c, "GET", GuildsEndpoint+"/templates/"+templateCode, nil, 1)
}
...
func (c *Client) GetGuildTemplates(guildID string) ([]discord.GuildTemplate, error) {
	return DoRequestAsList[discord.GuildTemplate](c, "GET", GuildsEndpoint+"/"+guildID+"/templates", nil, 1)
}
